<div class="comments index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('commenter'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['commenter']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['body']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($comment['Upload']['id'], array('controller' => 'uploads', 'action' => 'view', $comment['Upload']['id'])); ?>
		</td>
